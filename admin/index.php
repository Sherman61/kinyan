...
$stats = [
    ...
    'Open errors' => app_open_error_count(),
];
...
<section class="dashboard">
    ...
    <nav class="admin-tabs"><a href="listings.php">Listings</a><a href="wanted.php">Wanted</a><a href="reports.php">Reports</a><a href="errors.php">Errors<?= $stats['Open errors'] ? ' (' . (int)$stats['Open errors'] . ')' : '' ?></a><a href="users.php">Users</a><a href="categories.php">Categories</a><a href="settings.php">Settings</a></nav>
