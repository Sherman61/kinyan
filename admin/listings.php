...
<section class="dashboard">
    ...
    <div class="table-wrap"><table><thead><tr><th>Listing</th><th>Status</th><th>Featured</th><th>User</th><th>Actions</th></tr></thead><tbody>
    <?php foreach ($stmt->fetchAll() as $car): ?><tr>
